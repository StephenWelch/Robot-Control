...
import static math.Util.epsilonEquals;
...
public class RigidTransform2d implements Interpolable<RigidTransform2d> {
    ...
    public RigidTransform2d(double magnitude, double radians) {
        rotation_ = Rotation2d.fromRadians(radians);
        translation_ = new Translation2d(magnitude, rotation_);
    }
