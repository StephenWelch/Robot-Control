...
import math.interpolation.InterpolatingDouble;
import math.interpolation.InterpolatingTreeMap;
...
public class PoseTracker {
    ...
    private DifferentialDrive driveKinematics;
    ...
    public PoseTracker(DifferentialDrive driveKinematics) {
    ...
    public void update(double leftAbsolutePosition, double rightAbsolutePosition, double absoluteAngle, double leftVelocity, double rightVelocity, double angularVelocity, double timestamp) {
        ...
        Twist2d distanceTraveled = driveKinematics.forwardKinematics(leftDelta, rightDelta, Rotation2d.fromRadians(angleDelta));
        Twist2d velocity = driveKinematics.forwardKinematics(leftVelocity, rightVelocity, Rotation2d.fromRadians(angularVelocity));
