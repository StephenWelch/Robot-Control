...
public class Translation2d implements Interpolable<Translation2d> {
    ...
    public Translation2d(double magnitude, Rotation2d rotation) {
        x_ = magnitude * rotation.sin();
        y_ = magnitude * rotation.cos();
    }
     ...
     *
     * @param other
     * @return Other translation minus this translation
     */
    public Translation2d translationTo(Translation2d other) {
        return this.inverse().translateBy(other);
    }
